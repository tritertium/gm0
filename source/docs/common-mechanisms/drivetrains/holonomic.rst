...
- `GripForce™ Mecanum Wheel Set  <https://www.gobilda.com/gripforce-mecanum-wheel-set-o104mm-40a-durometer-rollers/>`_ ($142.49 with team discount): The GripForce™ Mecanum Wheels are the gold standard for teams wanting a quality design in all aspects. They feature a 104mm diameter and a thickness of 38mm, with ball bearing supported, 740A durometer rollers that provide excellent strafing performance. With the use of recessed 16x16mm and 32x32mm holes, these wheels have the largest amount of mounting options and can fit all shaft styles commonly used in FTC\ |reg|.
...
- `goBILDA Mecanum Wheels v2 <https://www.gobilda.com/96mm-mecanum-wheel-set-70a-durometer-bearing-supported-rollers/>`_: While these wheels continue to be a great option if teams do not have the wheels above, the goBILDA v2 mecanum wheels suffer from lower traction compared to GripForce™, and are known to have ground clearance issues with heavier robots as the outer plates tend to rub against the foam tiles.
